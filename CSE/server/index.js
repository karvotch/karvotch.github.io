...
app.get('/',(request,response) => {
    ...
    if (filePath == './' || extname == '.js' || extname == '.css') {
        if(filePath == './') {
            // filePath = 'W:/WebDev/pages/karvotch.github.io/CSE/clothingSearchEngine.html';
            filePath = __dirname + '/clothingSearchEngine.html';
        }
        var extname = String(path.extname(filePath)).toLowerCase();
        var mimeTypes = {
            '.html': 'text/html',
...
app.get('/style.css',(request,response) => {
    ...
    var extname = String(path.extname(filePath)).toLowerCase();
    console.log(extname);
    // filePath = 'W:/WebDev/pages/karvotch.github.io/CSE/style.css';
